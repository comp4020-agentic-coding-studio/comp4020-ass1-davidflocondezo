...
I think I want to be a software developer who often reflects back to "What is the 
point of what i'm developing/What am I trying to achieve" Twice in this build I was 
deep in development and thought about how to make the explainer more tidy, simpler 
and easier for the user. The problem is that when I ended up making it "Better" it 
was better but it was losing a core aspect of the explanation. One of the example 
is me wanting to remove the working panel once all the steps were completed which 
would mean not having a lasting before/after comparison. I think I want to pause 
and ask "what is my build trying to achieve" and get into that habit. While weighing 
the user interaction vs what the goal of what i'm doing is.
